...
data class RoomResponse(
    ...
    data class Room(
        ...
        @SerializedName("name")
        val name: String = "",
        @SerializedName("roomReservationDTOList")
        val roomReservationDTOList: List<RoomReservationDTO> = listOf(),
        ...
        data class RoomReservationDTO(
            ...
            @SerializedName("usersBooking")
            val usersBooking: UsersBooking = UsersBooking()
        ) : Parcelable {
            @Parcelize
