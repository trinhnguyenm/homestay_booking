...
class HostBookingAdapter(private val bookings: List<Booking>) :
    RecyclerView.Adapter<HostBookingAdapter.ItemHolder>() {
    ...
    inner class ItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun onBind(item: Booking) {
            itemView.apply {
                ...
                tvPlaceType.text = item.user.firstName + " " + item.user.lastName
