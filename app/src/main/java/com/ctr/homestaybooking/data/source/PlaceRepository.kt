...
class PlaceRepository : PlaceDataSource {
    ...
    override fun getPlacesByHostId(id: Int) = placeRemoteDataSource.getPlacesByHostId(id)
    ...
    override fun getBookingByHostId(id: Int) = placeRemoteDataSource.getBookingByHostId(id)
